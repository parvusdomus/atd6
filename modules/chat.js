export default class atd6Chat {
    ...
    static _spendKarma (event, data){
      ...
      const archivo_template = '/systems/atd6/templates/chat/test-result-karma.html';
    ...
    static _gainResolve (event, data){
      ...
      const messageId = $(element)
            ...
            .attr('data-message-id');
      const message = game.messages.get(messageId)
      let msg_content="<div class=\"atd6 test-result\"><h3 class=\"disabled\">"+game.i18n.localize("TRI.ui.acceptIntrusion")+"</h3></div>"
